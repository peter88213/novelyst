...
[Download the latest release (version 1.5.0)](https://raw.githubusercontent.com/peter88213/novelyst/main/dist/novelyst_v1.5.0.zip)

- Unzip the downloaded zipfile "novelyst_v1.5.0.zip" into a new folder.
