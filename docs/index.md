...
[Download the latest release (version 4.4.3)](https://raw.githubusercontent.com/peter88213/novelyst/main/dist/novelyst_v4.4.3.zip)

- Unzip the downloaded zipfile "novelyst_v4.4.3.zip" into a new folder.
