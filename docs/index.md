...
[Download the latest release (version 0.1.7)](https://raw.githubusercontent.com/peter88213/novelyst/main/dist/novelyst_v0.1.7.zip)

- Unzip the downloaded zipfile "novelyst_v0.1.7.zip" into a new folder.
