...
[Download the latest release (version 4.2.4)](https://raw.githubusercontent.com/peter88213/novelyst/main/dist/novelyst_v4.2.4.zip)

- Unzip the downloaded zipfile "novelyst_v4.2.4.zip" into a new folder.
