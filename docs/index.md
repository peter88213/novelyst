...
[Download the latest release (version 3.1.1)](https://raw.githubusercontent.com/peter88213/novelyst/main/dist/novelyst_v3.1.1.zip)

- Unzip the downloaded zipfile "novelyst_v3.1.1.zip" into a new folder.
