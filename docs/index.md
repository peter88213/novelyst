...
[Download the latest release (version 1.6.2)](https://raw.githubusercontent.com/peter88213/novelyst/main/dist/novelyst_v1.6.2.zip)

- Unzip the downloaded zipfile "novelyst_v1.6.2.zip" into a new folder.
