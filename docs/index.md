...
[Download the latest release (version 0.6.1)](https://raw.githubusercontent.com/peter88213/novelyst/main/dist/novelyst_v0.6.1.zip)

- Unzip the downloaded zipfile "novelyst_v0.6.1.zip" into a new folder.
