...
[Download the latest release (version 1.3.1)](https://raw.githubusercontent.com/peter88213/novelyst/main/dist/novelyst_v1.3.1.zip)

- Unzip the downloaded zipfile "novelyst_v1.3.1.zip" into a new folder.
