...
[Download the latest release (version 4.7.0)](https://raw.githubusercontent.com/peter88213/novelyst/main/dist/novelyst_v4.7.0.zip)

- Unzip the downloaded zipfile "novelyst_v4.7.0.zip" into a new folder.
