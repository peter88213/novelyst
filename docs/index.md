...
[Download the latest release (version 4.8.2)](https://raw.githubusercontent.com/peter88213/novelyst/main/dist/novelyst_v4.8.2.zip)

- Unzip the downloaded zipfile "novelyst_v4.8.2.zip" into a new folder.
