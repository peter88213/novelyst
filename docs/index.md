...
[Download the latest release (version 2.0.5)](https://raw.githubusercontent.com/peter88213/novelyst/main/dist/novelyst_v2.0.5.zip)

- Unzip the downloaded zipfile "novelyst_v2.0.5.zip" into a new folder.
