...
- [Python](https://www.python.org/) version 3.9.10 min.; version 3.10 max.
...
[Download the latest release (version 1.6.3)](https://raw.githubusercontent.com/peter88213/novelyst/main/dist/novelyst_v1.6.3.zip)

- Unzip the downloaded zipfile "novelyst_v1.6.3.zip" into a new folder.
