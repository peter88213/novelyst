...
[Download the latest release (version 0.8.0)](https://raw.githubusercontent.com/peter88213/novelyst/main/dist/novelyst_v0.8.0.zip)

- Unzip the downloaded zipfile "novelyst_v0.8.0.zip" into a new folder.
