...
[Download the latest release (version 0.4.3)](https://raw.githubusercontent.com/peter88213/novelyst/main/dist/novelyst_v0.4.3.zip)

- Unzip the downloaded zipfile "novelyst_v0.4.3.zip" into a new folder.
