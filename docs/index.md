...
[Download the latest release (version 1.3.3)](https://raw.githubusercontent.com/peter88213/novelyst/main/dist/novelyst_v1.3.3.zip)

- Unzip the downloaded zipfile "novelyst_v1.3.3.zip" into a new folder.
