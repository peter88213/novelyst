...
[Download the latest release (version 4.2.5)](https://raw.githubusercontent.com/peter88213/novelyst/main/dist/novelyst_v4.2.5.zip)

- Unzip the downloaded zipfile "novelyst_v4.2.5.zip" into a new folder.
