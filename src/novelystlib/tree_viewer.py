...
class TreeViewer:
    ...
    def __init__(self, ui, window, **kwargs):
        ...
        self.tree.tag_configure('root', background='white', font=('', fontSize, 'bold'))
        self.tree.tag_configure('chapter', background='white', foreground=kwargs['color_chapter'])
        self.tree.tag_configure('unused', background='white', foreground=kwargs['color_unused'])
        self.tree.tag_configure('notes', background='white', foreground=kwargs['color_notes'])
        self.tree.tag_configure('todo', background='white', foreground=kwargs['color_todo'])
        self.tree.tag_configure('part', background='white', font=('', fontSize, 'bold'))
        self.tree.tag_configure('notes part', background='white', foreground=kwargs['color_notes'], font=('', fontSize, 'bold'))
        self.tree.tag_configure('major', background='white', foreground=kwargs['color_major'])
        self.tree.tag_configure('minor', background='white', foreground=kwargs['color_minor'])
        self.tree.tag_configure('Outline', background='white', foreground=kwargs['color_outline'])
        self.tree.tag_configure('Draft', background='white', foreground=kwargs['color_draft'])
        self.tree.tag_configure('1st Edit', background='white', foreground=kwargs['color_1st_edit'])
        self.tree.tag_configure('2nd Edit', background='white', foreground=kwargs['color_2nd_edit'])
        self.tree.tag_configure('Done', background='white', foreground=kwargs['color_done'])
