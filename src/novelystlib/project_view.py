...
class ProjectView(BasicView):
    ...
    def __init__(self, ui, element):
        ...
        def set_initial_wc():
            self._wordCountStart.set(ui.wordCount)
        ...
        ww = ui.wordCount - element.wordCountStart
        try:
            wp = f'({round(100*ww/element.wordTarget)}%)'
        except ZeroDivisionError:
            wp = ''
        wordsWritten = tk.StringVar(value=f'{ww} {wp}')
